...
const Card = ({ room }) => {
  return (
    ...
    <div div class="p-4 bg-white border border-gray-200 hover:-translate-y-1 transition duration-300 rounded-lg shadow shadow-black/10 max-w-75">
        ...
        <p class="text-gray-900 text-md font-semibold mr-2 text-left ml-1">
            ${(room.priceCents / 100).toFixed(2)} <span className="text-xs">per night</span>
        </p>
        </div>
    </div>
    </Link>
